...
| REDIS_URL | Cache y coordinación; el agente local usa `localhost:6380`. |
| REDIS_HOST_PORT | Puerto host del Redis principal, 6380 para no chocar con Redis de pruebas en 6379. |
